...
export default {
  ...
  methods: {
    ...
    getBrandLogoPath(brand) {
        const brandMap = {
          'YONEX': 'Yonex_Logo.png',
          'LI- NING': 'Li- Ning_Logo.png',
          'VICTOR': 'Victor_Logo.png',
        };
        const logoFilename = brandMap[brand] || 'defaultImg.png'; 
        return `http://localhost:3000/assets/Brand_Logo/${logoFilename}`;
      }
  }
};
