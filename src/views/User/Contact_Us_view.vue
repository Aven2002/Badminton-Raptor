<template>
    ...
    <div class="full-width-container  d-flex justify-content-center align-items-center">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <img src='@/assets/Icon/ContactLogo.png' alt="Contact Image" class="img-fluid mb-3">
